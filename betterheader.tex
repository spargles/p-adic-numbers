...
%03/03/18 , slight modifications (notation added), Niklas
%14/05/19 removed Yannis tikz stuff and loaded tikz-cd instead. Also changes to numeration (now strictly increasing within chapter), Niklas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{fancyhdr}
	...
	\fancyhead[R]{
		\footnotesize
		Niklas Gassner\\
		\href{mailto:niklas.gassner@uzh.ch}{niklas.gassner@uzh.ch}
	}
	%Header left
	\fancyhead[L]{
		\footnotesize
...
\usepackage{tikz-cd}
% everything until enumitem is one thing
%\usepackage{tikz}
...
\newtheoremstyle{bold}              	 %Name
  ...
  { }                                    %Space after theorem head, ' ', 
  										 %	or \newline
  {} 
%Notes for numeration: \newtheorem{def}{def}[section] makes counter that resets at every section. \newtheorem{}[def]{} means the counter of def is followed
\theoremstyle{bold}
